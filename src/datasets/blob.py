...
class Blob(Dataset):
    ...
    def __init__(self, root, split, num_samples=100, num_features=10, num_centers=10, noise=1.0):
        ...
        self.noise = noise
        control_list = [self.num_samples, self.num_features, self.num_centers, self.noise]
    ...
    def make_data(self):
        ...
        x, y = make_blobs(n_samples=self.num_samples, n_features=self.num_features, centers=self.num_centers,
                          cluster_std=self.noise, random_state=0)
        ...
        classes = list(map(str, list(range(self.num_centers))))
