...
from data import fetch_dataset, make_data_loader, make_dataset_normal, make_batchnorm_stats
...
def runExperiment():
    ...
    test_logger = make_logger(os.path.join('output', 'runs', 'train_{}'.format(cfg['model_tag'])))
