...
# CNN
python make.py --mode init --model cnn --data CIFAR10 --run make --num_experiments 3 --round 12 --split_round 1 --init_seed 2

python make.py --mode teacher --model cnn --data CIFAR10 --run train --num_experiments 3 --round 12 --split_round 1 --init_seed 2
python make.py --mode teacher --model cnn --data CIFAR10 --run test --num_experiments 3 --round 12 --split_round 1 --init_seed 2

python make.py --mode once --model cnn --data CIFAR10 --run train --num_experiments 4 --round 12 --split_round 1
python make.py --mode once --model cnn --data CIFAR10 --run test --num_experiments 4 --round 12 --split_round 1

python make.py --mode lt --model cnn --data CIFAR10 --run train --num_experiments 4 --round 12 --split_round 1
python make.py --mode lt --model cnn --data CIFAR10 --run test --num_experiments 4 --round 12 --split_round 1

python make.py --mode si --model cnn --data CIFAR10 --run train --num_experiments 4 --round 12 --split_round 1
python make.py --mode si --model cnn --data CIFAR10 --run test --num_experiments 4 --round 12 --split_round 1

# ResNet
python make.py --mode init --model resnet18 --data CIFAR10 --run make --num_experiments 3 --round 12 --split_round 1 --init_gpu 1 --init_seed 2

python make.py --mode teacher --model resnet18 --data CIFAR10 --run train --num_experiments 3 --round 12 --split_round 1 --init_gpu 1 --init_seed 2
python make.py --mode teacher --model resnet18 --data CIFAR10 --run test --num_experiments 3 --round 12 --split_round 1 --init_gpu 1 --init_seed 2

python make.py --mode once --model resnet18 --data CIFAR10 --run train --num_experiments 4 --round 12 --split_round 1
python make.py --mode once --model resnet18 --data CIFAR10 --run test --num_experiments 4 --round 12 --split_round 1

python make.py --mode lt --model resnet18 --data CIFAR10 --run train --num_experiments 4 --round 12 --split_round 1
python make.py --mode lt --model resnet18 --data CIFAR10 --run test --num_experiments 4 --round 12 --split_round 1

python make.py --mode si --model resnet18 --data CIFAR10 --run train --num_experiments 4 --round 12 --split_round 1
python make.py --mode si --model resnet18 --data CIFAR10 --run test --num_experiments 4 --round 12 --split_round 1